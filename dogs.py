...
class Dogs(VisionDataset):
    ...
    def convert_annotation(self,image_name):
        in_file = open('./data/dogs/Annotation/%s'%(image_name.split('.')[0]))
    ...
    def __getitem__(self, index):
        ...
        box = self.convert_annotation(image_name)
        image = np.array(image)[box[2]:box[3],box[0]:box[1]]
